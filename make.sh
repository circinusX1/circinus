...
pushd src
includes="-I./sq/sqrat/include/sqrat -I./sq/include -I./sq/squirrel -I./sq/sqrat -I./sq/sqrat/include -I./builtin -I./drivers/platform/linux/raspberrypi -I./drivers -I./drivers/common -I./comm  -I./rapidjson/include -I./"
