...
public:
	...
	/// \param f
	///
	static void getFoo(HSKVM vm, Sqrat::Object& o, const SQChar* slot, Sqrat::Function& f)
	{
		SQ_PTRS->addref(vm, &f.GetEnv());
		Object so = o.GetSlot(slot);
		if(!so.IsNull())
		{
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 2, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 2, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 3, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 3, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 4, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 4, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 5, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 5, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 6, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 6, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 7, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 7, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 8, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 8, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 9, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 9, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 10, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 10, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 11, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 11, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 12, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 12, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 13, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 13, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 14, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 14, true, ErrorHandling::IsEnabled());
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 15, true, ErrorHandling::IsEnabled());
...
#else
		SQ_PTRS->call(vm, 15, true, ErrorHandling::IsEnabled());
#endif
	...
	void Execute() {
		...
		SQRESULT result = SQ_PTRS->call(vm, 1, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 1, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 3, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 3, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 4, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 4, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 5, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 5, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 6, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 6, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 7, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 7, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 8, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 8, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 9, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 9, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 10, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 10, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 11, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 11, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 12, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 12, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 13, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 13, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 14, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 14, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
		SQRESULT result = SQ_PTRS->call(vm, 15, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
...
#else
		SQ_PTRS->call(vm, 15, false, ErrorHandling::IsEnabled());
		SQ_PTRS->settop(vm, top);
#endif
	}
...
struct Var<Function> {
	...
	static void push(HSKVM vm, const Function& value) {
		SQ_PTRS->pushobject(vm, value.GetMemb());
	}
};
